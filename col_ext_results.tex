...
\hypersetup{unicode=true,
            pdftitle={Colonization Extinction results},
            pdfborder={0 0 0},
            breaklinks=true}
...
\setlength{\droptitle}{-2em}
  ...
  \title{Colonization Extinction results}
...
\includegraphics{col_ext_results_files/figure-latex/unnamed-chunk-1-1.pdf}
...
``Models in the 2-7 range have some support and should rarely be
dismissed'' Burnham Anderson Huyvaert
