...
```{bash limit to depths included in trawl survey}
...
soda3.3.1_1980_2015_sst_final.nc
soda3.3.1_1980_2015_sbt_trawl_final.nc
soda2.2.4_1953_1979_sst.nc
soda2.2.4_1953_1979_sbt_trawl_final.nc


Now, we should be able to merge pre 1979 and post 1979
```{bash Final Merge}
#surface
ncrcat soda2.2.4_1953_1979_sst_timefix.nc -O soda3.3.1_1980_2015_sst_final_timefix.nc soda_sst.nc
ncrcat soda2.2.4_1953_1979_sbt.nc -O soda3.3.1_1980_2015_sbt_final.nc soda_sbt.nc
...
soda_surface_3.3.1<- get.soda.3.3.1("soda3.3.1_1980_2015_sst_final.nc")
...
#save
writeRaster(soda_surface, "soda_surface_sep2019.grd")
```

Now, we have to extract GPS points from bottom temperature, I expect this to be more difficult. 
```{bash split into years}
#first, 1053-1979
soda2.2.4_1953_1979_sbt_trawl_final.nc

ncks -d time,0,364 data.nc 1991.nc
```