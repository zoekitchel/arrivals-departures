...
load(here::here("Data","Spp_master", "spp_master_ztemp_seus_buoy.traits.RData"))
```
...
temptraitvars <- grep(pattern = "*_s.t_*|tl|age.maturity|length.max|age.max",colnames(spp_master_ztemp_seus_buoy.traits), value = T)
...
save(spp_master_ztemp_seus_buoy.traits_scaled, file = here::here("Data","Spp_master", "spp_master_ztemp_seus_buoy.traits_scaled.RData"))
```
