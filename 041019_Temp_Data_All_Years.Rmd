...
for (i in 1:nrow(hauls)) {
  ...
  subset_sst <- soda_sst_monthavg[region == this_region & month_julian >= this_month_julian_reverse[2] & soda_sst_monthavg$month_julian <= this_month_julian_reverse[1]]
  mean_sst_temp_lag1 <- mean(subset_sst$sst_mean)
  max_sst_temp_lag1 <- max(subset_sst$sst_mean)
  min_sst_temp_lag1 <- min(subset_sst$sst_mean)
  
  seas_sst_temp_lag1 <- max_sst_temp - min_sst_temp
