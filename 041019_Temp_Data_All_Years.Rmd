...
for (i in 1:nrow(hauls)) {
  ...
  #surface raw lags 
    ...
    #surface change
    hauls[(i),mean_sst_temp_change :=  mean_sst_temp[i]-mean_sst_temp_lag1[i]]
    hauls[(i),max_sst_temp_change :=  max_sst_temp[i]-max_sst_temp_lag1[i]]
    hauls[(i),min_sst_temp_change :=  min_sst_temp[i]-min_sst_temp_lag1[i]]
    hauls[(i),seas_sst_temp_change :=  seas_sst_temp[i]-seas_sst_temp_lag1[i]]
...
only first value shows:
mean_sst_temp_change
max_sst_temp_change
min_sst_temp_change 
seas_sst_temp_change 
mean_sst_temp_change_abs
max_sst_temp_change_abs 
min_sst_temp_change_abs 
seas_sst_temp_change_abs
