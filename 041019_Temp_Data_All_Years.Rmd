...
#surface
#raw
  hauls$mean_sst_temp <- NA
  hauls$max_sst_temp <- NA
  hauls$min_sst_temp <- NA
  hauls$seas_sst_temp <- NA
  
  
  #lag raw
  hauls$mean_sst_temp_lag1 <- NA
  hauls$mean_sst_temp_lag2 <- NA
  hauls$mean_sst_temp_lag3 <- NA
  hauls$mean_sst_temp_lag4 <- NA
  hauls$mean_sst_temp_lag5 <- NA
  hauls$mean_sst_temp_lag6 <- NA
  hauls$mean_sst_temp_lag7 <- NA
  hauls$mean_sst_temp_lag8 <- NA
  hauls$mean_sst_temp_lag9 <- NA
  hauls$mean_sst_temp_lag10 <- NA
  
  hauls$max_sst_temp_lag1 <- NA
  hauls$max_sst_temp_lag2 <- NA
  hauls$max_sst_temp_lag3 <- NA
  hauls$max_sst_temp_lag4 <- NA
  hauls$max_sst_temp_lag5 <- NA
  hauls$max_sst_temp_lag6 <- NA
  hauls$max_sst_temp_lag7 <- NA
  hauls$max_sst_temp_lag8 <- NA
  hauls$max_sst_temp_lag9 <- NA
  hauls$max_sst_temp_lag10 <- NA
  
  hauls$min_sst_temp_lag1 <- NA
  hauls$min_sst_temp_lag2 <- NA
  hauls$min_sst_temp_lag3 <- NA
  hauls$min_sst_temp_lag4 <- NA
  hauls$min_sst_temp_lag5 <- NA
  hauls$min_sst_temp_lag6 <- NA
  hauls$min_sst_temp_lag7 <- NA
  hauls$min_sst_temp_lag8 <- NA
  hauls$min_sst_temp_lag9 <- NA
  hauls$min_sst_temp_lag10 <- NA
  
  hauls$seas_sst_temp_lag1 <- NA
  hauls$seas_sst_temp_lag2 <- NA
  hauls$seas_sst_temp_lag3 <- NA
  hauls$seas_sst_temp_lag4 <- NA
  hauls$seas_sst_temp_lag5 <- NA
  hauls$seas_sst_temp_lag6 <- NA
  hauls$seas_sst_temp_lag7 <- NA
  hauls$seas_sst_temp_lag8 <- NA
  hauls$seas_sst_temp_lag9 <- NA
  hauls$seas_sst_temp_lag10 <- NA
 
  
  #change
  hauls$mean_sst_temp_change <- NA
  hauls$max_sst_temp_change <- NA
  hauls$min_sst_temp_change <- NA
  hauls$seas_sst_temp_change <- NA

  
  #lag change
  hauls$mean_sst_temp_change_lag1 <- NA
  hauls$mean_sst_temp_change_lag2 <- NA
  hauls$mean_sst_temp_change_lag3 <- NA
  hauls$mean_sst_temp_change_lag4 <- NA
  hauls$mean_sst_temp_change_lag5 <- NA
  hauls$mean_sst_temp_change_lag6 <- NA
  hauls$mean_sst_temp_change_lag7 <- NA
  hauls$mean_sst_temp_change_lag8 <- NA
  hauls$mean_sst_temp_change_lag9 <- NA
  hauls$mean_sst_temp_change_lag10 <- NA
  
  hauls$max_sst_temp_change_lag1 <- NA
  hauls$max_sst_temp_change_lag2 <- NA
  hauls$max_sst_temp_change_lag3 <- NA
  hauls$max_sst_temp_change_lag4 <- NA
  hauls$max_sst_temp_change_lag5 <- NA
  hauls$max_sst_temp_change_lag6 <- NA
  hauls$max_sst_temp_change_lag7 <- NA
  hauls$max_sst_temp_change_lag8 <- NA
  hauls$max_sst_temp_change_lag9 <- NA
  hauls$max_sst_temp_change_lag10 <- NA
  
  hauls$min_sst_temp_change_lag1 <- NA
  hauls$min_sst_temp_change_lag2 <- NA
  hauls$min_sst_temp_change_lag3 <- NA
  hauls$min_sst_temp_change_lag4 <- NA
  hauls$min_sst_temp_change_lag5 <- NA
  hauls$min_sst_temp_change_lag6 <- NA
  hauls$min_sst_temp_change_lag7 <- NA
  hauls$min_sst_temp_change_lag8 <- NA
  hauls$min_sst_temp_change_lag9 <- NA
  hauls$min_sst_temp_change_lag10 <- NA
  
  hauls$seas_sst_temp_change_lag1 <- NA
  hauls$seas_sst_temp_change_lag2 <- NA
  hauls$seas_sst_temp_change_lag3 <- NA
  hauls$seas_sst_temp_change_lag4 <- NA
  hauls$seas_sst_temp_change_lag5 <- NA
  hauls$seas_sst_temp_change_lag6 <- NA
  hauls$seas_sst_temp_change_lag7 <- NA
  hauls$seas_sst_temp_change_lag8 <- NA
  hauls$seas_sst_temp_change_lag9 <- NA
  hauls$seas_sst_temp_change_lag10 <- NA
...
for (i in 1:nrow(hauls)) {
  this_month_julian <- hauls$month_julian[i]
  this_region <- hauls$region[i]
  monthstosubtract <- seq(from = 11, by = 12, length.out = 11)
  
  this_month_julian_reverse <- NA
  for (j in 1:length(monthstosubtract)){
    this_month_julian_reverse[j] <- this_month_julian-monthstosubtract[j]
  }
  #surface
  subset_sst <- soda_sst_monthavg[region == this_region & month_julian >= this_month_julian_back1year & soda_sst_monthavg$month_julian <= this_month_julian]
  ...
  #surface raw lags 
  hauls$mean_sst_temp_lag1
  this_month_julian_back2year <- month_julian-23
  subset_sst <- soda_sst_monthavg[region == this_region & month_julian >= this_month_julian_back2year & soda_sst_monthavg$month_julian <= this_month_julian_back1year]
  mean_sst_temp <- mean(subset_sst$sst_mean)
  max_sst_temp <- max(subset_sst$sst_mean)
  min_sst_temp <- min(subset_sst$sst_mean)
