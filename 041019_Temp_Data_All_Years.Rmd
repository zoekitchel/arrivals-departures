...
NC file for 1980-2015 surface temp `soda3.3.1_1980_2015_sst_final.nc`
NC file for 1980-2015 bottom temp `soda3.3.1_1980_2015_sbt_final.nc`
...
I'm going to use my code instead of Ryan's for now. 
```{r netcdf to brick}
library(raster)
library(ncdf4)
soda3_sst <- "/Users/zoekitchel/Downloads/soda3.3.1_1980_2015_sst_final.nc"
#terminal soda3_sst <- "soda3.3.1_1980_2015_sst_final.nc"
soda3_sst.b <- brick(soda3_sst)  

soda3_sst.b

#plotting to figure out where things went wrong


# 1. Open jpeg file
jpeg("rplot3.jpg", width = 400)
# 2. Create the plot
plot(soda3_sst.b[[3]])
# 3. Close the file
dev.off()
...
soda3_sbt <- "/Users/zoekitchel/Downloads/soda3.3.1_1980_2015_sbt_final.nc"
soda3_sbt.b <- brick(soda3_sbt)  

soda3_sbt.b

plot(soda3_sbt.b[[30]])

soda2_sst <- "/Users/zoekitchel/Downloads/soda2.2.4_1953_1979_sst.nc"
soda2_sst.b <- soda2_sst
