...
cumulative_richness[,richness_obs_sum := col_obs_sum-ext_obs_sum][,richness_pred_sum := col_pred_sum-ext_pred_sum]

#plot richness over time predicted versus observed
ggplot(aes(x=year), data = cumulative_richness) +
  geom_point(aes(y = richness_obs_sum), col = "red") +
  geom_point(aes(y = richness_pred_sum), col = "black", size = 1) +
