...
RVI_col[, type := factor(type, levels = c("Depth", "Transformation", "Measurement", "lag"))]

RVI_col_nolag <- RVI_col[type != "lag",]
RVI_col_nolag[, type := factor(type, levels = c("Depth", "Transformation", "Measurement"))][, variable := factor(variable, levels = c("Bottom", "Surface","  ", "Raw", "Change", "|Change|", "Min", "Max", "Seas"))]
...
RVI_ext[, type := factor(type, levels = c("Depth", "Transformation", "Measurement", "lag"))]

RVI_ext_nolag <- RVI_ext[type != "lag",]
RVI_ext_nolag[, type := factor(type, levels = c("Depth", "Transformation", "Measurement"))][, variable := factor(variable, levels = c("Bottom", "Surface","  ", "Raw", "Change", "|Change|", "Min", "Max", "Seas"))]
