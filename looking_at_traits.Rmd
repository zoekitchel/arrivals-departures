...
AICc(mod.e.t.0.1, mod.e.t.1.1)
  ...
  #min_sst_temp_change_lag2 and             -0.144548 0.048814  3889.425
      #                       age.max      -0.029182 4.7e-09
          #interaction?
                mod.e.t.1.1.i <- glmer(now_ext ~ min_sst_temp_change_lag2 * age.max + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na)
...
mod.e.t.1.r <- glmer(now_ext ~ age.max + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na)
summary(mod.e.t.1.r)
AICc(mod.e.t.1.r)
...
hist(spp_master_ztemp.traits$age.maturity)
...
#does it hold up with this limited data set?
mod.c.age.maturity.0 <- glmer(col ~ max_sbt_temp_change_abs + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
...
mod.c.age.maturity.1 <- glmer(col ~ max_sbt_temp_change_abs + age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
...
#interaction?
mod.c.age.maturity.2 <- glmer(col ~ max_sbt_temp_change_abs * age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
summary(mod.c.tl.2)
...
mod.c.age.maturity.3 <- glmer(col ~ age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
