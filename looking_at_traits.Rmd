...
spp_master_spp <- data.frame(spp = unique(spp_master$spp), origin = "spp_master")
...
```{r Etrumeus teres}
spp_master[spp == "Etrumeus teres(sadina)", spp := "Etrumeus teres"]
...
spp_master[spp == "Macrorhamphosus scolopax", spp := "Macroramphosus scolopax"]
```
...
spp_master[spp == "Myliobatis freminvillii", spp := "Myliobatis freminvillei"]
```
...
spp_master[spp == "Polydactylus octoemus", spp := "Polydactylus octonemus"]
```
...
traits[taxon == "Stichaeus punctatus punctatus", taxon := "Stichaeus punctatus"][species == "punctatus punctatus", species := "punctatus"]
...
spp_master[spp == "Symphurus civitatum", spp := "Symphurus civitatium"]
...
spp_master[spp == "Zenopsis conchifera", spp := "Zenopsis conchifer"]
