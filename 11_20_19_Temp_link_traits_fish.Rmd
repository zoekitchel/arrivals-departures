...
min temp importance = 0.0091
max temp importance = 0.979
seas temp importance = 0.0114
...
min temp importance = 0.265
max temp importance = 0.269
seas temp importance = 0.465
...
RVI_table.r <- RVI_table.r %>% 
  dplyr::mutate("variable" = factor(variable, 
                                    levels = c("bottom", "no_lag", "raw", "change", "absolute_value_change", "min", "max", "seas")))

save(RVI_table, file = "RVI_table.Rdata")

ggplot(data = RVI_table.r, aes(x=variable, y = value, fill = col_ext)) +
  geom_bar(stat = "identity", position = "dodge") +
  scale_x_discrete(breaks = c("bottom", "no_lag", "raw", "change", "absolute_value_change", "Min", "Max", "Seas"), labels = c("Bottom Temp", "No Lag", "Raw Temp", "Change in Temp", "| Change in Temp |", "Minimum Temp", "Maximum Temp", "Seasonality")) +
...
levels(RVI_table) <- c("bottom", "surface", "absolute_value_change", "change", "raw", "no_lag", "lagged", "min", "max", "seas")
