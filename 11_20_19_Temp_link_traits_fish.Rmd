...
col_nolag_importance <- sum(colonization_model_comparisons[!grep("lag", variable), ]$akaike_weight)
...
col_change_importance <- sum(colonization_model_comparisons[grep("change", variable), ][!grep("abs", variable),]$akaike_weight)
