...
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="AFSC_Aleutians"] <- "ai"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="AFSC_EBS"] <- "ebs"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="AFSC_GOA"] <- "goa"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="AFSC_WCTri"] <- "wctri"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="DFO_Newfoundland"] <- "newf"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="DFO_ScotianShelf"] <- "shelf"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="NEFSC_NEUS"] <- "neus"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="SCDNR_SEUS"] <- "se"
levels(date_temp_reg_avg_withlags.naomit$reg)[levels(date_temp_reg_avg_withlags.naomit$reg)=="SEFSC_GOMex"] <- "gmex"
...
spp_master_ztemp <- left_join(spp_master, date_temp_reg_avg_withlags.naomit, by = c("reg", "year"))

spp_master_ztemp <- merge(spp_master, date_temp_reg_avg_withlags.naomit)
#make sure all na are gone

spp_master_ztemp_naomit <- na.omit(spp_master_ztemp)
...
plot(date_temp_reg_avg_withlags$year, date_temp_reg_avg_withlags$region_year_mean_sst) #mean temp through time
plot(date_temp_reg_avg_withlags$year, date_temp_reg_avg_withlags$region_year_min_sst) #min temp through time
plot(date_temp_reg_avg_withlags$year, date_temp_reg_avg_withlags$region_year_max_sst) #max temp through time
plot(date_temp_reg_avg_withlags$year, date_temp_reg_avg_withlags$region_year_seas_sst) #seasonality through time
```
