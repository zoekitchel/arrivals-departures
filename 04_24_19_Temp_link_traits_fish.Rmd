...
```
Just realizing now that I currently have data from 12 months before each trawl event. This isn't appropriate, as my colonization/extinction data is per year. FOR NOW (before I speak with Malin), I will just use earlier month in each year. 
...
cols <- c(5,38:286)
hauls2.r <- hauls2[, ..cols] #.. pulls in variable
...
Max and medium are medium correlated, but I'll still keep it in (0.87)
...
dredgesubset <- spp_master_ztemp[,c(1:3,6,45:292)] # this will have to change
