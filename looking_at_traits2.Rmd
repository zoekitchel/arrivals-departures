...
variable | coefficient | p | AICc | rank above | coef above
---------|-------------|----|-----|---|---|
| 1 | min_sst_temp_change_lag2	-0.14436022	0.003038827	3930.580	
| 2 |  seas_sbt_temp_change_lag9	0.12993554	0.005210505	3931.628	
| 3 |  seas_sbt_temp_lag9	0.10972665	0.013229764	3933.519	
| 4 |  max_sbt_temp_change_abs	0.15427483	0.017742274	3933.821	
| 5 |  min_sst_temp_change_abs_lag6	0.16578612	0.020123707	3934.268	
| 6 |  min_sbt_temp_change_abs_lag5	-0.23173199	0.036076360	3934.596	
| 7 | seas_sbt_temp_change_abs	0.12245319	0.032188793	3934.761	
| 9 |  max_sbt_temp_change_lag9	0.11439746	0.035588475	3934.905	
| 10 | seas_sst_temp	-0.09460166	0.050126076	3935.655	
| 11 | min_sst_temp_change_abs_lag5	-0.15868171	0.063866384	3935.761	
| 12 | seas_sst_temp_lag2	0.07970154	0.044236722	3935.820	
| 13 |	 seas_sst_temp_change_abs_lag5	-0.11465158	0.071676787	3935.918	
| 14 | seas_sst_temp_change_lag2	0.06818593	0.069610050	3936.028	
| 15 | seas_sst_temp_change	-0.07118644	0.077429810	3936.153	
...
#new base model (best model with no traits added)
mod.e.agemax.0 <- glmer(now_ext ~ max_sbt_temp_change_abs + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.max)
...
#max_sbt_temp_change_abs and age.max
mod.e.agemax.1 <- glmer(now_ext ~ max_sbt_temp_change_abs + age.max + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.max)
...
mod.e.agemax.3 <- glmer(now_ext ~ age.max + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na)
...
#new base model (best model with no traits added)
mod.e.agematurity.0 <- glmer(now_ext ~ max_sbt_temp_change_abs + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
...
#max_sbt_temp_change_abs and age.maturity
mod.e.agematurity.1 <- glmer(now_ext ~ max_sbt_temp_change_abs + age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
...
#interaction?
mod.e.agematurity.2 <- glmer(now_ext ~ max_sbt_temp_change_abs * age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.age.maturity)
...
#what about only age at maturity?
mod.e.agematurity.3 <- glmer(now_ext ~ age.maturity + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na)
...
#new base model (best model with no traits added)
mod.e.tl.0 <- glmer(now_ext ~ max_sbt_temp_change_abs + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.tl)
summary(mod.e.tl.0)
AICc(mod.e.tl.0)
```
...
#max_sbt_temp_change_abs and tl
mod.e.tl.1 <- glmer(now_ext ~ max_sbt_temp_change_abs + tl + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.tl)
summary(mod.e.tl.1)
AICc(mod.e.tl.1)
...
#interaction?
mod.e.tl.2 <- glmer(now_ext ~ max_sbt_temp_change_abs * tl + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na.tl)
summary(mod.e.tl.2)
AICc(mod.e.tl.2)
```
...
#what about only trophic level?
mod.e.tl.3 <- glmer(now_ext ~ tl + (1|reg) + (1|year_factor), family = binomial, data = spp_master_ztemp.traits.na)
summary(mod.e.tl.3)
AICc(mod.e.tl.3)
