...
spp_master_richness <- spp_master_ztemp %>%
  ...
  summarise("richness" = sum(present), 
            ...
            "seas_sbt_temp_change_abs" =mean(seas_sbt_temp_change_abs),
            ...
            "seas_sbt_temp_change" =mean(seas_sbt_temp_change),
            ...
            "seas_sbt_temp" = mean(seas_sbt_temp))
...
#Absolute Change
#abs change mods for abline
abs_change_seas_mod <- lm(rich~bt_trend_seas_abs_change, data = trends)
