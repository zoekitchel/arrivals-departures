...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=mean_sbt_temp_change), col = "black") +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  theme_classic() +
...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=mean_sst_temp_change), col = "black") +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  theme_classic() +
...
#SBT
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=max_sbt_temp_change), col = "red", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=min_sbt_temp_change), col = "blue", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=mean_sbt_temp_change), col = "black", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
...
#SST
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=max_sst_temp_change), col = "red", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=min_sst_temp_change), col = "blue", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
...
ggplot(data = spp_master_richness, aes(y = richness_change)) +
  geom_point(aes(x=mean_sst_temp_change), col = "black", size = 1) +
  labs(y = "Raw Richness Change") +
  geom_hline(aes(yintercept = 0)) +
  geom_vline(aes(xintercept = 0)) +
  facet_wrap(~reg) +
