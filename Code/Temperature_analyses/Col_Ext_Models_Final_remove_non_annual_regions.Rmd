...
departure_model_comparison_annual_obs_taxonomy <-#best readRDS(here::here("Model_results","departure_model_comparison_annual_obs_taxonomy.rds"))
...
AICc(intercept_arrival_mod_scaled)-min(arrival_model_comparison_annual_obs_nomean$AICc)
AICc(intercept_departure_mod_scaled)-min(departure_model_comparison_annual_obs_nomean$AICc)
...
fwrite(arrival_model_comparison_annual_obs_nomean_akaikeweights, file = here::here("tables","arrival_model_comparison_annual_obs_nomean_akaikeweights_annual_obs.csv"))
