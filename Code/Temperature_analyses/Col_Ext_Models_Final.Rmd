...
load(here("Data","Spp_master", "spp_master_ztemp_seus_buoy_scaled.RData"))
```
...
readRDS(file = here("Model_results","arrival_model_comparison_nomean_akaikeweights.rds"))
...
readRDS(file = here("Model_results","departure_model_comparison_nomean_akaikeweights.rds"))
```
