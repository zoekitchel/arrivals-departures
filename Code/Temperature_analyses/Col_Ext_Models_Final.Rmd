...
gain_model_comparison_taxonomy[, variable:=as.factor(V1)][, coef:=as.numeric(V1)][, p_value:=as.numeric(V1)][, conditional_R2 := as.numeric(V1)][,marginal_R2 := as.numeric(V1)][, AICc:=as.numeric(V1)]
...
for (i in 1:length(variables_scaled)){
  ...
  gain_model_comparison_taxonomy[i,conditional_R2 := rsquared[2,2]]
  gain_model_comparison_taxonomy[i,marginal_R2 := rsquared[2,1]]
...
#2nd best
mod_extrarandom_gain_2 <- glmer(gain ~ max_sst_temp_lag10_scaled  + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)
#3rd best
mod_extrarandom_gain_3 <- glmer(gain ~ seas_sst_temp_lag5_scaled  + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)

#4th best
mod_extrarandom_gain_4 <- glmer(gain ~ max_sst_temp_lag8_scaled  + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)
...
gain_confint_1 <- confint.merMod(mod_extrarandom_gain, method = "Wald")
gain_confint_2 <- confint.merMod(mod_extrarandom_gain_2, method = "Wald")
gain_confint_3 <- confint.merMod(mod_extrarandom_gain_3, method = "Wald")
gain_confint_4 <- confint.merMod(mod_extrarandom_gain_4, method = "Wald")

fixef(mod_extrarandom_gain)[2]-gain_confint[9,1]
fixef(mod_extrarandom_gain_2)[2]-gain_confint_2[9,1]
fixef(mod_extrarandom_gain_3)[2]-gain_confint_3[9,1]
fixef(mod_extrarandom_gain_4)[2]-gain_confint_4[9,1]
...
loss_model_comparison_taxonomy[, variable:=as.factor(V1)][, coef:=as.numeric(V1)][, p_value:=as.numeric(V1)][, conditional_R2 := as.numeric(V1)][,marginal_R2 := as.numeric(V1)][, AICc:=as.numeric(V1)]
loss_model_comparison_taxonomy[, V1 := NULL]

for (i in 1:length(variables_scaled)){
  mod <- glmer(loss ~ get(variables_scaled[i]) + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp),
               family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)
  ...
  loss_model_comparison_taxonomy[i,conditional_R2 := rsquared[2,2]]
  loss_model_comparison_taxonomy[i,marginal_R2 := rsquared[2,1]]
...
mod_extrarandom_loss_2 <- glmer(loss ~ max_sst_temp_change_abs_lag1_scaled  + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)

mod_extrarandom_loss_3 <- glmer(loss ~ 	
seas_sst_temp_change_lag2_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)

mod_extrarandom_loss_4 <- glmer(loss ~ max_sst_temp_lag7_scaled  + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = binomial, data = spp_master_ztemp_seus_buoy_scaled, nAGQ = 0)
...
loss_confint_1 <- confint.merMod(mod_extrarandom_loss, method = "Wald")
loss_confint_2 <- confint.merMod(mod_extrarandom_loss_2, method = "Wald")
loss_confint_3 <- confint.merMod(mod_extrarandom_loss_3, method = "Wald")
loss_confint_4 <- confint.merMod(mod_extrarandom_loss_4, method = "Wald")

fixef(mod_extrarandom_loss)[2]-loss_confint_1[9,1]
fixef(mod_extrarandom_loss_2)[2]-loss_confint_2[9,1]
fixef(mod_extrarandom_loss_3)[2]-loss_confint_3[9,1]
fixef(mod_extrarandom_loss_4)[2]-loss_confint_4[9,1]
...
gain_model_comparison_taxonomy <- rbind(gain_model_comparison_taxonomy, gain_null_row, use.names = F)
loss_model_comparison_taxonomy <- rbind(loss_model_comparison_taxonomy, loss_null_row, use.names = F)
