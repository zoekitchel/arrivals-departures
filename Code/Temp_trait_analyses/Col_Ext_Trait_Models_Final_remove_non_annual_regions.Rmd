...
AICc(mod_traitonly_arrival)-AICc(mod1_arrival) #from table, 3569.182, 37.56
AICc(mod_temponly_arrival)-AICc(mod1_arrival)
AICc(mod_null_arrival)-AICc(mod1_arrival)

mod <- glmer(col ~ 0 + age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)

mod <- glmer(col ~ age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)

	
mod <- glmer(col~ 0 + length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)

mod2 <- glmer(col~ length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
