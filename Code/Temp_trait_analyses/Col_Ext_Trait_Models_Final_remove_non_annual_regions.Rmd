...
arrival.reduced_annual_obs <- arrival.reduced_annual_obs[complete.cases(arrival.reduced_annual_obs[ , .(age.max_ocean_scaled, age.maturity_ocean_scaled, length.max_ocean_scaled, tl_ocean_scaled)]),]
...
all.temp.variables <- colnames(arrival.reduced_annual_obs[,9:256])
...
for (i in 1:nrow(full_var_set.r2)){
  ...
  mod <- glmer(formula, family = binomial, data = arrival.reduced_annual_obs, nAGQ = 0)
...
#save this table
saveRDS(arrival_model_comparisons_traits.lag9max_annual_obs,file = "/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/Col_Ext/Model_results/Traits/arrival_model_comparison_traits_annual_obs.rds")
...
#only raw temp has lag of 10 years, which means variable importance comparisons are unbalanced so I will get rid of these rows
departure_model_comparisons_traits.lag9max <- departure_model_comparison_traits_annual_obs[!grepl("lag10", temp_variable), ]
...
#save this table
saveRDS(departure_model_comparisons_traits.lag9max, "/Users/zoekitchel/Documents/grad school/Rutgers/Repositories/Col_Ext/Model_results/Traits/departure_model_comparison_traits_annual_obs.rds")
```
...
mod1_arrival <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
mod2_arrival <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + length.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
mod3_arrival <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + tl_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
mod4_arrival <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)

mod_traitonly_arrival <- glmer(col ~ age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
mod_temponly_arrival <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
mod_null_arrival <- glmer(col ~ (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
...
mod1_departure <- glmer(now_ext ~ max_sst_temp_lag1_scaled * age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)

mod2_departure <- glmer(now_ext ~ max_sst_temp_scaled * age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)
mod3_departure <- glmer(now_ext ~ max_sst_temp_lag1_scaled * age.max_ocean_scaled + length.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)
mod4_departure <- glmer(now_ext ~ max_sst_temp_lag1_scaled * age.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)
mod5_departure <- glmer(now_ext ~ max_sst_temp_lag1_scaled * age.max_ocean_scaled + tl_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)

mod_traitonly_departure <- glmer(now_ext ~ age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)
mod_temponly_departure <- glmer(now_ext ~ max_sst_temp_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs.r, nAGQ = 0)
...
AICc(mod_traitonly_departure)-AICc(mod1_departure) #18.46734
AICc(mod_temponly_departure)-AICc(mod1_departure) #8.211203
AICc(mod_null_departure)-AICc(mod1_departure) #24.025178
...
mod_arrival_trait <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)

#temp only arrival trait model seas_sst_temp_scaled
mod_arrival_trait_notraits <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
summary(mod_arrival_trait_notraits)

#trait only arrival trait model
mod_arrival_trait_notemp <- glmer(col ~ age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_annual_obs, nAGQ = 0)
...
#best model with fish only 
mod_departure_trait <- glmer(now_ext ~ max_sst_temp_lag1_scaled * age.max_ocean_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_annual_obs, nAGQ = 0)
