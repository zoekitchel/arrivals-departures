...
NB: deleted + (1|phylum) because there's only one phylum (chordata)
...
colmod1 <- glmer(col ~max_sst_temp_change_abs_lag1_scaled	*	age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod2 <- glmer(col ~max_sbt_temp_lag6_scaled	*	age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod3 <- glmer(col ~ max_sbt_temp_lag4_scaled	*	age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod4 <- glmer(col ~max_sst_temp_change_abs_lag1_scaled	*	age.max_ocean_scaled + tl_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod5 <- glmer(col ~max_sbt_temp_lag3_scaled	*	age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod6 <- glmer(col ~max_sst_temp_change_abs_lag1_scaled	*	age.max_ocean_scaled + age.maturity_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

colmod7 <- glmer(col ~max_sbt_temp_lag6_scaled	*	age.max_ocean_scaled + tl_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)
...
#no trait
colmod_notrait <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)
...
now_extmod1 <- glmer(now_ext ~max_sst_temp_lag6_scaled	*	length.max_ocean_scaled + age.max_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod2 <- glmer(now_ext ~max_sst_temp_lag6_scaled	*	length.max_ocean_scaled + age.maturity_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod3 <- glmer(now_ext ~ max_sst_temp_lag5_scaled	*	length.max_ocean_scaled + age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod4 <- glmer(now_ext ~max_sst_temp_lag5_scaled	*	length.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod5 <- glmer(now_ext ~max_sst_temp_scaled	*	length.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod6 <- glmer(now_ext ~min_sst_temp_lag8_scaled	*	age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod7 <- glmer(now_ext ~max_sst_temp_scaled	*	length.max_ocean_scaled + age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod8 <- glmer(now_ext ~max_sst_temp_lag2_scaled	*	length.max_ocean_scaled + age.maturity_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod9 <- glmer(now_ext ~max_sst_temp_lag2_scaled	*	length.max_ocean_scaled + age.max_ocean_scaled+ (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod10 <- glmer(now_ext ~ max_sst_temp_lag1_scaled	*	length.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod11 <- glmer(now_ext ~ max_sst_temp_lag1_scaled	*	length.max_ocean_scaled + age.max_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod12 <- glmer(now_ext ~ min_sst_temp_lag8_scaled	*	age.max_ocean_scaled + tl_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

now_extmod13 <- glmer(now_ext ~ min_sst_temp_lag8_scaled	*	age.max_ocean_scaled + age.maturity_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)
...
#no trait
now_extmod_notrait <- glmer(now_ext ~ min_sst_temp_change_lag2_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)
...
r.squaredGLMM(now_extmod5)[4]
summary(now_extmod6)[10]
r.squaredGLMM(now_extmod6)[4]
summary(now_extmod7)[10]
r.squaredGLMM(now_extmod7)[4]
summary(now_extmod8)[10]
r.squaredGLMM(now_extmod8)[4]
summary(now_extmod9)[10]
r.squaredGLMM(now_extmod9)[4]
summary(now_extmod10)[10]
r.squaredGLMM(now_extmod10)[4]
summary(now_extmod11)[10]
r.squaredGLMM(now_extmod11)[4]
summary(now_extmod12)[10]
r.squaredGLMM(now_extmod12)[4]
summary(now_extmod13)[10]
r.squaredGLMM(now_extmod13)[4]
...
AICc(now_extmod7)-AICc(now_extmod1)
AICc(now_extmod8)-AICc(now_extmod1)
AICc(now_extmod9)-AICc(now_extmod1)
AICc(now_extmod10)-AICc(now_extmod1)
AICc(now_extmod11)-AICc(now_extmod1)
AICc(now_extmod12)-AICc(now_extmod1)
AICc(now_extmod13)-AICc(now_extmod1)
...
mod_arrival_trait <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)
...
#best model with fish only 
mod_departure_trait <- glmer(now_ext ~ max_sst_temp_lag6_scaled * length.max_ocean_scaled + age.max_ocean_scaled + (1|reg)  + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)
