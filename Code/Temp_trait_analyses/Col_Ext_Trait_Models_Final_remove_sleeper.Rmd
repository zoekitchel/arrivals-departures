...
spp_master_ztemp_seus_buoy.traits_scaled_logged.unique <- unique(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(spp, reg, age.maturity_ocean_logged, age.max_ocean_logged, tl_ocean, length.max_ocean_logged)])

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = age.maturity_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.maturity_ocean_logged)
