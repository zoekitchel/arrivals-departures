...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled.unique, aes(x = reg, y = age.maturity_ocean))  +
  geom_boxplot() +
  geom_text_repel(aes(label=outlier_age_mat), size = 1.5, nudge_y = 5) +
  theme_classic()
...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled.unique, aes(x = reg, y = age.max_ocean))  +
  geom_boxplot() +
  geom_text_repel(aes(label=outlier_age_max), size = 1.5, nudge_y = 5) +
  theme_classic()
...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled.unique, aes(x = reg, y = length.max_ocean))  +
  geom_boxplot() +
  geom_text_repel(aes(label=outlier_length.max), size = 1.5, nudge_y = 5) +
  theme_classic()
