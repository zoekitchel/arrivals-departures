...
all.temp.variables <- colnames(arrival.reduced_nosleeper.r[,9:256]) #CHECKKK
...
for (i in 1:nrow(full_var_set.r2)){
  ...
  raw_form <- ifelse(temp == 0 & trait != 0,
      paste("col ~", trait, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
          ifelse(temp != 0 & trait == 0,
           paste("col ~", temp, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
              ifelse(temp == 0 & trait == 0,
              paste("col ~", "(1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
                paste("col ~",temp,sign,trait, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"))))

  formula <- as.formula(raw_form)
  
  mod <- glmmTMB(formula, family = binomial, data = arrival.reduced_nosleeper.r)
...
for (i in 1:nrow(full_var_set.r2)){
  ...
  raw_form <- ifelse(temp == 0 & trait != 0,
      paste("now_ext ~", trait, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
          ifelse(temp != 0 & trait == 0,
           paste("now_ext ~", temp, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
              ifelse(temp == 0 & trait == 0,
              paste("now_ext ~", "(1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"),
                paste("now_ext ~",temp,sign,trait, "+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp)"))))

  formula <- as.formula(raw_form)
  
  mod <- glmmTMB(formula, family = binomial, data = departure.reduced_nosleeper.r)
...
colmod1 <- glmmTMB(col ~ max_sst_temp_change_abs_lag1_scaled*age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)

colmod2 <- glmmTMB(col ~ max_sst_temp_change_abs_lag1_scaled*age.max_ocean_scaled+tl_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)

colmod3 <- glmmTMB(col ~ 
max_sst_temp_change_abs_lag1_scaled*age.max_ocean_scaled+length.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)

colmod4 <- glmmTMB(col ~ max_sst_temp_change_abs_lag1_scaled*age.max_ocean_scaled+age.maturity_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)

#no temp
colmod_notemp <- glmmTMB(col ~ age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)
#no trait
colmod_notrait <- glmmTMB(col ~ max_sst_temp_change_abs_lag1_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)

#null

colmod_null <- glmmTMB(col ~ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)
...
now_extmod1 <- glmmTMB(now_ext ~ max_sst_temp_lag6_scaled*length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

now_extmod2 <- glmmTMB(now_ext ~ max_sst_temp_lag2_scaled*length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

now_extmod3 <- glmmTMB(now_ext ~ max_sst_temp_scaled*length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

now_extmod4 <- glmmTMB(now_ext ~ max_sst_temp_lag5_scaled*length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

now_extmod5 <- glmmTMB(now_ext ~ max_sst_temp_lag6_scaled*length.max_ocean_scaled + age.maturity_ocean_scaled+ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

now_extmod6 <- glmmTMB(now_ext ~ max_sst_temp_lag1_scaled*length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

#no temp
now_extmod_notemp <- glmmTMB(now_ext ~ age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)
#no trait
now_extmod_notrait <- glmmTMB(now_ext ~ min_sst_temp_change_lag2_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)

#null

now_extmod_null <- glmmTMB(now_ext ~ (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)
...
mod_arrival_trait <- glmmTMB(col ~ max_sst_temp_change_abs_lag1_scaled * age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r)
...
#best model with fish only 
mod_departure_trait <- glmmTMB(now_ext ~ max_sst_temp_lag6_scaled * length.max_ocean_scaled + age.max_ocean_scaled + (1|reg) + (1|phylum) + (1|class) + (1|order) + (1|family) + (1|genus) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r)
