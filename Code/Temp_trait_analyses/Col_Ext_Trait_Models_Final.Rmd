...
arrival.reduced.r <- arrival.reduced[complete.cases(arrival.reduced[ , .(age.max_scaled, age.maturity_scaled, length.max_scaled, tl_scaled)]),]
...
#delete any observations without full trait data
departure.reduced.r <- departure.reduced[complete.cases(departure.reduced[ , .(age.max_scaled, age.maturity_scaled, length.max_scaled, tl_scaled)]),]
...
mod_arrival_trait <- glmer(col ~ max_sst_temp_change_abs_lag1_scaled * age.maturity_scaled + age.max_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced.r, nAGQ = 0)

#using best predictor for all species in model instead
mod_arrival_trait_allspp <- glmer(col ~ seas_sst_temp_scaled * age.maturity_scaled + age.max_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced.r, nAGQ = 0)
...
mod_arrival_trait_notemp <- glmer(col ~ age.maturity_scaled + age.max_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced.r, nAGQ = 0)
...
#best model with fish only 
mod_departure_trait <- glmer(now_ext ~ max_sst_temp_scaled * age.maturity_scaled + age.max_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced.r, nAGQ = 0)

#using best predictor for all species in model instead
mod_departure_trait_allspp <- glmer(now_ext ~ seas_sst_temp_lag3_scaled * age.maturity_scaled + age.max_scaled + (1|reg) + (1|spp), family = "binomial", data = departure.reduced.r, nAGQ = 0)
