...
Updates from July 13, 2021: We are scaling and centering all temp variables, logging all longevity predictors, and doing nothing with trophic level
...
spp_master_ztemp_seus_buoy.traits_scaled_logged <- readRDS(here::here("Data","Spp_master","spp_master_ztemp_seus_buoy.traits_scaled_logged.rds"))
...
nrow(unique(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(spp, reg)]))
nrow(unique(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(spp, reg, age.maturity_ocean_logged, age.max_ocean_logged, tl_ocean, length.max_ocean_logged)]))
```

Looking at correlations among variables
```{r missing values}
summary(spp_master_ztemp_seus_buoy.traits_scaled_logged$age.max_ocean_logged) #702 missing
summary(spp_master_ztemp_seus_buoy.traits_scaled_logged$age.maturity_ocean_logged) #551 missing
summary(spp_master_ztemp_seus_buoy.traits_scaled_logged$tl_ocean) #none missing
summary(spp_master_ztemp_seus_buoy.traits_scaled_logged$length.max_ocean_logged) #none missing
summary(spp_master_ztemp_seus_buoy.traits_scaled_logged$length.infinity) #443 missing, this is highly correlated (0.82) with length max, so we'll just use length.max

cor(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(age.max_ocean_logged, age.maturity_ocean_logged, tl_ocean, length.max_ocean_logged)], use = "complete.obs")

pairs(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(age.max_ocean_logged, age.maturity_ocean_logged, tl_ocean, length.max_ocean_logged)])

```

What's the distribution of trait values?
```{r trait value distribution age maturity}
spp_master_ztemp_seus_buoy.traits_scaled_logged.unique <- unique(spp_master_ztemp_seus_buoy.traits_scaled_logged[,.(spp, reg, age.maturity_ocean_logged, age.max_ocean_logged, tl_ocean, length.max_ocean_logged, age.maturity_ocean, age.max_ocean, length.max_ocean)])

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = age.maturity_ocean_logged))  +
  geom_histogram() +
  theme_classic()
...
(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$age.maturity_ocean-mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.maturity_ocean, na.rm = T))/sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.maturity_ocean, na.rm = T) #17.38 SD from mean

(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$age.max_ocean-mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.max_ocean, na.rm = T))/sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.max_ocean, na.rm = T) #8.88 SD from mean

(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$length.max_ocean-mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$length.max_ocean, na.rm = T))/sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$length.max_ocean, na.rm = T) #11.14 SD from mean


sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.maturity_ocean, na.rm = T)
sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.max_ocean, na.rm = T)
sd(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$length.max_ocean, na.rm = T)

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$age.maturity_ocean
spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$age.max_ocean, na.rm = T)
spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[spp == "Somniosus pacificus",]$length.max_ocean, na.rm = T)


#what about when we leave out sleeper shark

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")], aes(x = age.maturity_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")]$age.maturity_ocean_logged)
...
spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,age_mat_outlier := is_outlier(age.maturity_ocean_logged, na.rm = T)]

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,outlier_age_mat := ifelse(age_mat_outlier == T, spp, NA)]
library(ggrepel)
#box plot would be helpful to see outliers
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = reg, y = age.maturity_ocean_logged))  +
  geom_boxplot() +
...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = age.max_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$age.max_ocean_logged)

#what about when we leave out sleeper shark

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")], aes(x = age.max_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")]$age.max_ocean_logged)

#marking outliers

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,age_max_outlier := is_outlier(age.max_ocean_logged, na.rm = T)]

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,outlier_age_max := ifelse(age_max_outlier == T, spp, NA)]
library(ggrepel)
#box plot would be helpful to see outliers
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = reg, y = age.max_ocean_logged))  +
  geom_boxplot() +
...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = tl_ocean))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$tl_ocean)

#what about when we leave out sleeper shark

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")], aes(x = tl_ocean))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")]$tl_ocean)

#marking outliers

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,tl_outlier := is_outlier(tl_ocean, na.rm = T)]

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,outlier_tl := ifelse(tl_outlier == T, spp, NA)]
library(ggrepel)
#box plot would be helpful to see outliers
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = reg, y = tl_ocean))  +
  geom_boxplot() +
...
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = length.max_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique$length.max_ocean_logged)

#what about when we leave out sleeper shark

ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")], aes(x = length.max_ocean_logged))  +
  geom_histogram() +
  theme_classic()

summary(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[(spp != "Somniosus pacificus")]$length.max_ocean_logged)

#marking outliers

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,length.max_outlier := is_outlier(length.max_ocean_logged, na.rm = T)]

spp_master_ztemp_seus_buoy.traits_scaled_logged.unique[,outlier_length.max := ifelse(length.max_outlier == T, spp, NA)]
library(ggrepel)
#box plot would be helpful to see outliers
ggplot(spp_master_ztemp_seus_buoy.traits_scaled_logged.unique, aes(x = reg, y = length.max_ocean_logged))  +
  geom_boxplot() +
...
tempvars <- grep(".*temp.*scaled", names(spp_master_ztemp_seus_buoy.traits_scaled_logged), value = T)

#other reference and trait columns we need
othervars_arrivals <- c("reg", "year", "col", "spp", "age.max_ocean_logged", "age.maturity_ocean_logged", "tl_ocean", "length.max_ocean_logged")

colstosaveforarrivals <- c(othervars_arrivals, tempvars)

#Arrival table
arrival.reduced_nosleeper <- spp_master_ztemp_seus_buoy.traits_scaled_logged[,colstosaveforarrivals, with = F][(spp != "Somniosus pacificus")] #reduces to columns we need, excludes sleeper shark (outlier)

#Departure table

othervars_departure <- c("reg", "year", "now_ext", "spp", "age.max_ocean_logged", "age.maturity_ocean_logged", "tl_ocean", "length.max_ocean_logged")
colstosavefordeparture <- c(othervars_departure, tempvars)

departure.reduced_nosleeper <- spp_master_ztemp_seus_buoy.traits_scaled_logged[,colstosavefordeparture, with = F][(spp != "Somniosus pacificus")] #reduces to columns we need, excludes sleeper shark (outlier)

spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper <- spp_master_ztemp_seus_buoy.traits_scaled_logged[(spp != "Somniosus pacificus")]
...
arrival.reduced_nosleeper.r <- arrival.reduced_nosleeper[complete.cases(arrival.reduced_nosleeper[ , .(age.max_ocean_logged, age.maturity_ocean_logged, length.max_ocean_logged, tl_ocean)]),]
...
all.trait.variables <- c(0, "tl_ocean", "age.max_ocean_logged","age.maturity_ocean_logged", "length.max_ocean_logged",
                         "tl_ocean + age.max_ocean_logged", "age.max_ocean_logged + tl_ocean",
                         "tl_ocean + age.maturity_ocean_logged", "age.maturity_ocean_logged + tl_ocean",
                         "tl_ocean + length.max_ocean_logged", "length.max_ocean_logged + tl_ocean",
                         "age.max_ocean_logged + age.maturity_ocean_logged", "age.maturity_ocean_logged + age.max_ocean_logged",
                         "age.max_ocean_logged + length.max_ocean_logged", "length.max_ocean_logged + age.max_ocean_logged",
                         "age.maturity_ocean_logged + length.max_ocean_logged", "length.max_ocean_logged + age.maturity_ocean_logged")
...
arrival_model_comparison_traits <- as.data.table(matrix(nrow = nrow(full_var_set.r))) 
...
for (i in 1:nrow(full_var_set.r)){
 
  temp <- full_var_set.r$Var1[i]
  sign <- full_var_set.r$Var2[i]
  trait <- full_var_set.r$Var3[i]
  ...
  arrival_model_comparison_traits[i,temp_variable := full_var_set.r$Var1[i]]
  arrival_model_comparison_traits[i,sign := full_var_set.r$Var2[i]]
  arrival_model_comparison_traits[i,trait_variable := full_var_set.r$Var3[i]]
...
saveRDS(arrival_model_comparison_traits, here::here("Model_results","Traits","arrival_model_comparison_traits_nosleeper_logged.rds"))

arrival_model_comparison_traits <- readRDS(here::here("Model_results","Traits","arrival_model_comparison_traits_nosleeper_logged.rds"))
...
#delete any observations without full trait data
departure.reduced_nosleeper.r <- departure.reduced_nosleeper[complete.cases(departure.reduced_nosleeper[ , .(age.max_ocean_logged, age.maturity_ocean_logged, length.max_ocean_logged, tl_ocean)]),]

departure_model_comparison_traits <- as.data.table(matrix(nrow = nrow(full_var_set.r))) 
...
for (i in 1:nrow(full_var_set.r)){
  ...
  departure_model_comparison_traits[i,temp_variable := full_var_set.r$Var1[i]]
  departure_model_comparison_traits[i,sign := full_var_set.r$Var2[i]]
  departure_model_comparison_traits[i,trait_variable := full_var_set.r$Var3[i]]
...
saveRDS(departure_model_comparison_traits, here::here("Model_results","Traits","departure_model_comparison_traits_nosleeper_logged.rds"))

departure_model_comparison_traits <- readRDS(here::here("Model_results","Traits","departure_model_comparison_traits_nosleeper_logged.rds"))
...
##arrival with Traits
Best model: min_sbt_temp_change_abs_lag5_scaled * length.max_ocean_logged + age.max_ocean_logged

All fish no traits: max_sst_temp_change_abs_lag1_scaled (this is quite different)
...
mod_arrival_trait <- glmer(col ~ min_sbt_temp_change_abs_lag5_scaled * length.max_ocean_logged + age.max_ocean_logged+ (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)

#temp only arrival trait model seas_sst_temp_scaled
mod_arrival_trait_notraits <- glmer(col ~ min_sbt_temp_change_abs_lag5_scaled + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)
summary(mod_arrival_trait_notraits)

#trait only arrival trait model
mod_arrival_trait_notemp <- glmer(col ~ length.max_ocean_logged + age.max_ocean_logged + (1|reg) + (1|spp), family = "binomial", data = arrival.reduced_nosleeper.r, nAGQ = 0)
summary(mod_arrival_trait_notemp)

#skip because we're justing using log
      #        #reverse to age maturity unscaled
      #        mod_arrival_reverse_scaled_agematurity <- lm(age.maturity_ocean ~ age.maturity_ocean_logged, data =       #spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper) 
      #        
      #        mod_arrival_forward_scaled_agematurity <- lm(age.maturity_scaled ~ age.maturity, data =       #spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper)
      #        
      #
        ##age maturity age match (save for departures)
        #length_max_match <- data.table(ages_we_want = c(0.5, 1, 3, 15,25))
        #age_match[,age.maturity_ocean_logged := exp(ages_we_want)]
        
#histogram of lengths
hist(unique(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper[,.(spp,length.max_ocean)]$length.max_ocean))

length_match <- data.table(lengths_we_want = c(5,50,100,300, 400,500))
length_match[,length.max_ocean_logged := log(lengths_we_want)]

#best predictor for fish only: max_sst_temp_change_abs_lag1_scaled as x axis
temp_arrival_newdata <- runif(500,min(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$min_sbt_temp_change_abs_lag5_scaled), max(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$min_sbt_temp_change_abs_lag5_scaled))

temp_length_newdata <- length_match[,length.max_ocean_logged] #length

#also extract mean values for when best model does not include specified trait
temp_agemax_newdata_mean <- mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$age.max_ocean_logged, na.rm = T)


arrival_newdata_traits <- expand.grid("min_sbt_temp_change_abs_lag5_scaled" = temp_arrival_newdata, "length.max_ocean_logged" = temp_length_newdata, "age.max_ocean_logged" = temp_agemax_newdata_mean)
...
preds_predictors <- preds_predictors[length_match, on = "length.max_ocean_logged"]

#I want x axis to be meaningful
mod_arrival_reverse_scaledtemp <- lm(min_sbt_temp_change_abs_lag5 ~ min_sbt_temp_change_abs_lag5_scaled, data = spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper)


preds_predictors[,min_sbt_temp_change_abs_lag5 := mod_arrival_reverse_scaledtemp$coefficients[2]*min_sbt_temp_change_abs_lag5_scaled + mod_arrival_reverse_scaledtemp$coefficients[1] ]


(arrival_preds <- ggplot(data = preds_predictors, aes(x = min_sbt_temp_change_abs_lag5, y = preds, color = as.factor(lengths_we_want))) +
  geom_line(size = 1) +
  labs(colour="Maximum\nLength", x = "Absolute change in minimum bottom\ntemperature lagged 5 years (˚C)", y = "Probability of Arrival") +
...
Best model: 	max_sst_temp_scaled * length.max_ocean_logged + age.maturity_ocean_logged

Best model from analyses with temperature only: max_sst_temp_scaled

```{r predicted values departure}
#best model with fish only 
mod_departure_trait <- glmer(now_ext ~ max_sst_temp_scaled * length.max_ocean_logged + age.maturity_ocean_logged + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

#using best predictor for all species in model instead
mod_departure_trait_allspp <- glmer(now_ext ~ seas_sst_temp_lag3_scaled * length.max_ocean_logged + age.maturity_ocean_logged + (1|reg) + (1|spp), family = "binomial", data = departure.reduced_nosleeper.r, nAGQ = 0)

#delete, using log instead
      #reverse to length max unscaled
   #   mod_departure_reverse_scaled_lengthmax <- lm(length.max ~ length.max_ocean_logged, data = spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper) 
      
   #   mod_departure_forward_scaled_lengthmax <- lm(length.max_ocean_logged ~ length.max, data = spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper)
...
temp_departure_newdata <- runif(500,min(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$max_sst_temp_scaled), max(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$max_sst_temp_scaled))

temp_lengthmax_newdata <- length_match[,length.max_ocean_logged]


temp_agematurity_newdata <- mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$age.maturity_ocean_logged, na.rm = T)

departure_newdata_traits <- expand.grid("max_sst_temp_scaled" = temp_departure_newdata, "length.max_ocean_logged" = temp_lengthmax_newdata, "age.maturity_ocean_logged" = temp_agematurity_newdata)
...
#I want x axis to be meaningful
mod_departure_reverse_scaledtemp <- lm(max_sst_temp ~ max_sst_temp_scaled, data = spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper)
...
temp_departure_newdata_seas <- runif(500,min(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$seas_sst_temp_lag3_scaled), max(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$seas_sst_temp_lag3_scaled))

temp_agematurity_newdata_seas <- age_match[,age.maturity_ocean_logged]


temp_agemax_newdata_seas <- mean(spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper$age.max_scaled, na.rm = T)

departure_newdata_traits_seas <- expand.grid("seas_sst_temp_lag3_scaled" = temp_departure_newdata_seas, "age.maturity_ocean_logged" = temp_agematurity_newdata_seas, "age.max_scaled" = temp_agemax_newdata_seas)
...
preds_predictors_seas <- preds_predictors_seas[age_match, on = "age.maturity_ocean_logged"]

#I want x axis to be meaningful
mod_departure_reverse_scaledtemp_seas <- lm(seas_sst_temp_lag3 ~ seas_sst_temp_lag3_scaled, data = spp_master_ztemp_seus_buoy.traits_scaled_logged.nosleeper)
