...
I currently have data from 12 months before each trawl event. This isn't appropriate, as my observations of arrivals and departures is per year, not per season or trawl. FOR NOW (before I speak with Malin, update spoke to Malin he agreed that this worked), I will just use earliest month in each year. 
...
saveRDS(spp_master_ztemp, here::here("Data","Spp_master","spp_master_ztemp.Rdata"))
```
