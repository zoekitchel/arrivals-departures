...
dates_over_time <- ggplot(data = data_over_time.u, aes(x = YYYY, y = Location, fill = as.factor(exist))) +
  ...
  theme_classic() +
  labs(x="Year", y = "Buoy ID and Location", fill = "Data Availability")
...
(FigureS2 <- plot_grid(sup1_1, legend, nrow = 2, rel_heights = c(5,1)))
  

ggsave(here::here("figures","Supplemental", "FigureS1.eps"), height = 4, width = 8)
