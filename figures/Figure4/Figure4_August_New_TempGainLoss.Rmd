...
#plot confidence
g0 <- ggplot(temp_gains_newdata, aes(x=seas_sst_temp_scaled, y=exp(col)/(1+exp(col)))) +
  geom_line(size = 0.1)
g0 + geom_ribbon(aes(ymin = exp(plo)/(1+exp(plo)), ymax = exp(phi)/(1+exp(phi))))+
