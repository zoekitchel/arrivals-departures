...
mod_gain_reverse_scaledtemp <- lm(seas_sst_temp ~ max_sst_temp_change_abs_lag1_scaled, data = spp_master_ztemp_seus_buoy_scaled_annual_obs)


temp_gains_newdata[,seas_sst_temp := mod_gain_reverse_scaledtemp$coefficients[2]*max_sst_temp_change_abs_lag1_scaled + mod_gain_reverse_scaledtemp$coefficients[1] ]
...
(gain_preds_temp_only <- ggplot() +
  ...
  geom_point(data = spp_master_ztemp_seus_buoy_scaled_annual_obs, aes(x = seas_sst_temp, y = col), size = 2, shape = "|") +
...
ggsave(gain_preds_temp_only, path = here::here("figures/Supplemental"), file = "Figure4_gains_CI_annual_only.jpg")
ggsave(gain_preds_temp_only, path = here::here("figures/Supplemental"), file = "Figure4_gains_CI_annual_only.eps")
...
(loss_preds_temp_only <- ggplot() +
  ...
  geom_point(data = spp_master_ztemp_seus_buoy_scaled_annual_obs, aes(x = seas_sst_temp_lag3, y = now_ext), size = 2, shape = "|") +
...
ggsave(loss_preds_temp_only, path = here::here("figures/Supplemental"), file = "Figure4_losses_CI_annual_only.jpg")
ggsave(loss_preds_temp_only, path = here::here("figures/Supplemental"), file = "Figure4_losses_CI_annual_only.eps")
```
...
ggsave(gains_losses_preds_CI, path = here::here("figures/Supplemental"), file = "Figure4_gain_loss_merge_annual_only.jpg", height = 4, width = 7, units = "in")
ggsave(gains_losses_preds_CI, path = here::here("figures/Supplemental"), file = "Figure4_gain_loss_merge_annual_only.eps", height = 4, width = 7, units = "in")
```
