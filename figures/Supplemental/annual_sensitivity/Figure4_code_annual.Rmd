...
RVI_arrival_nolag <- readRDS(here::here("Model_results", "RVI_arrival_nolag_annual_obs.rds"))
RVI_departure_nolag <- readRDS(here::here("Model_results", "RVI_departure_nolag_annual_obs.rds"))
```
