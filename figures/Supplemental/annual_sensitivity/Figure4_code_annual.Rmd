...
ggsave(here("figures","Supplemental","annual_sensitivity","Figure4a_annual.eps" ))
...
ggsave(here("figures","Supplemental","annual_sensitivity","Figure4b_annual.eps" ))
...
figure3_new_annual <- plot_grid(lags_over_time_annual_regs, figure4_wlegend, ncol = 1, nrow = 2, labels = c("a.","",""), vjust = 1)

ggsave(figure3_new_annual, path = here("figures","Supplemental","annual_sensitivity"), filename = "figure3_new_annual.eps", height = 6, width = 7.5, units = "in")
```
