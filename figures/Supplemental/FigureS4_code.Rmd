...
ggsave(final_temp_region_plot, height = 8, width = 9.7, units = "in", path = "~/Documents/grad school/Rutgers/Repositories/Col_Ext/figures/Supplemental", filename = "S4_regional_temp_over_time.eps")
```
